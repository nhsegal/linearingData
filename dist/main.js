...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "*{\n  box-sizing: border-box;\n}\nh1 {\n  font-size: 32px;\n  margin: 1rem 2rem;\n}\n\nh2 {\n  font-size: 22px;\n  margin: 0 0.1rem 0.5rem 0rem;\n}\n\n#explanation {\n  display: none;\n}\n\nbody {\n  font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;\n  margin-left: 1em;\n  background: #F5F5F5;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n}\n\nmain{\n  display: flex;\n  flex-direction: row;\n  gap: 20px;\n}\n\n.left{\n  width: calc(50% - 250px);\n  padding: 0 1rem;\n}\n\n\n\n.chart-container{\n  width: 490px;\n  height: 500px;\n  border: 1px solid black;\n  padding: 5px 2px 1px 15px; \n  border-radius: 10px;\n  background-color: white;\n}\n\n\n.right{\n  width: calc(50% - 250px);\n  padding: 0rem 1rem;\n}\n\ninput[type=button] {\n  background: #99ddee;\n  -webkit-border-radius: 15;\n  -moz-border-radius: 15;\n  border-radius: 5px;\n  width: 100%;\n  color: black;\n  font-size: 16px;\n  padding: 5px 10px 5px 10px; \n  text-decoration: none;\n  margin: 0;\n}\n\nbutton {\n  background: #99ddee;\n  -webkit-border-radius: 15;\n  -moz-border-radius: 15;\n  border-radius: 5px;\n  width: 100%;\n  color: black;\n  font-size: 16px;\n  padding: 5px 10px 5px 10px; \n  text-decoration: none;\n  margin: 0 0 1rem 0;\n}\n\n.plotdiv {\n  margin: 0rem 0rem 2rem 0rem;\n}\n\ninput[type=range] {\n  margin: .25rem 0 1.5rem 2rem;\n}\n\ninput[type=radio] {\n  margin: 0 0 0 2rem;\n}\n\nspan {\n  margin-left: 0px;\n}\n\n#eq {\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  justify-content: center;\n  gap:2px;\n  font-size: 2rem;\n  margin-bottom: 1rem;\n}\n\n\n #dep_var, #indep_var{\n  display: inline;\n  font-size: 2rem;\n}\n\n#exp{\n  position: relative;\n  top: -1.5rem;\n  width: 3rem;\n}\n\n\nul {\n  font-family: sans-serif;\n\n}\n\n.eq-label {\n  margin-left: 2rem;\n}\n\n\n.trendline-container-math {\n  font-size: 1.75rem;\n  border: 1px solid grey;\n  border-radius: 10px;\n  height: 3rem;\n  width: 90%;\n  margin-left: 2rem;\n  margin-bottom: 1rem;\n  padding-top: 6px;\n  text-align: center;\n  background-color: rgb(230, 230, 230);\n  font-family: 'Times New Roman', Times, serif;  \n}\n\n#trendline-equation-x-math, \n#trendline-equation-x-physics,\n#trendline-equation-y-math,\n#trendline-equation-y-physics{\n  font-style: italic;\n}\n\n\n#trendline-equation-x-math sup, \n#trendline-equation-x-physics sup,\n#trendline-equation-y-math sup,\n#trendline-equation-y-physics sup{\n  \n  font-size: 1.2rem;\n  font-style: normal;\n  position: relative;\n  top: -3px;\n  left: 4px;\n}\n\n\n.trendline-container-physics {\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  justify-content: center;\n  gap: 2px;\n  font-family: 'Times New Roman', Times, serif;\n  font-size: 1.75rem;\n  border: 1px solid red;\n  border-radius: 10px;\n  height: 3rem;\n  width: 90%;\n  margin-left: 2rem;\n  \n  text-align: center;\n  background-color: rgb(252, 252, 37);\n}\n\n\n.trendline {\n  display: inline-block;\n}\n\n\n.fraction {\n  display: inline-block;\n  position: relative;\n  vertical-align: middle; \n  letter-spacing: 0.001em;\n  text-align: center;\n  font-size: 14px;\n  }\n\n.fraction > span { \n  display: block; \n  }\n.fraction span.fdn {border-top: thin solid black;}\n.fraction span.bar {display: none;}\n\n.fraction sup {\n  position: relative;\n}\n\n#coefficient {\n  width: 4rem;\n  height: 2rem;\n}\n\n#modal {\n  display: none;\n}\n \n#modal.visible {\n  position: fixed;\n  top: 0rem;\n  left: 0vh;\n  padding: 0.5rem 1rem;\n  background-color: white;\n  border: 1px black solid;\n  display: block;\n  z-index: 1;\n  width: 100%; /* Full width */\n  height: 100%; /* Full height */\n  overflow: auto; /* Enable scroll if needed */\n  background-color: rgb(0,0,0); /* Fallback color */\n  background-color: rgba(0,0,0,0.4); /* Black w/ opacity */\n  font-family:Arial, Helvetica, sans-serif;\n\n}\n\n#modal-button {\n  width: 16rem;\n  position: absolute;\n  top: 1rem;\n  right:2rem;\n  background-color: rgb(200,200,200);\n}\n\n.modal-content {\n  background-color: #fefefe;\n  margin: 5% auto; \n  padding: 30px;\n  border: 1px solid #888;\n  width: 80%; /* Could be more or less, depending on screen size */\n  border-radius: 10px;\n}\n\n.modal-content span{\n  position: relative;\n  top: -15px;\n  right: -7px;\n\n}\n\n.modal-content h2 {\n  margin-top: 1rem;\n}\n\n/* The Close Button */\n.close {\n  color: #aaa;\n  float: right;\n  font-size: 28px;\n  font-weight: bold;\n}\n\n.close:hover,\n.close:focus {\n  color: black;\n  text-decoration: none;\n  cursor: pointer;\n}\n\n.plotted-trendline-container {\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n  color: blue;\n  font-size: 1rem;\n  position: relative;\n    left: 8rem;\n    top: -9rem;\n  align-items: center;\n}\n\n#plotted-trendline-x, #plotted-trendline-y, #plotted-trendline-slope{\n  font-size: 1.5rem;\n  font-family: 'Times New Roman', Times, serif; \n}\n#plotted-trendline-slope-3{\nmargin: 2px;\n}\n\n#error{\n  color: rgb(250, 0, 0);\n}", "",{"version":3,"sources":["webpack://./src/main.css"],"names":[],"mappings":"AAAA;EACE,sBAAsB;AACxB;AACA;EACE,eAAe;EACf,iBAAiB;AACnB;;AAEA;EACE,eAAe;EACf,4BAA4B;AAC9B;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,mJAAmJ;EACnJ,gBAAgB;EAChB,mBAAmB;EACnB,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,uBAAuB;AACzB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,SAAS;AACX;;AAEA;EACE,wBAAwB;EACxB,eAAe;AACjB;;;;AAIA;EACE,YAAY;EACZ,aAAa;EACb,uBAAuB;EACvB,yBAAyB;EACzB,mBAAmB;EACnB,uBAAuB;AACzB;;;AAGA;EACE,wBAAwB;EACxB,kBAAkB;AACpB;;AAEA;EACE,mBAAmB;EACnB,yBAAyB;EACzB,sBAAsB;EACtB,kBAAkB;EAClB,WAAW;EACX,YAAY;EACZ,eAAe;EACf,0BAA0B;EAC1B,qBAAqB;EACrB,SAAS;AACX;;AAEA;EACE,mBAAmB;EACnB,yBAAyB;EACzB,sBAAsB;EACtB,kBAAkB;EAClB,WAAW;EACX,YAAY;EACZ,eAAe;EACf,0BAA0B;EAC1B,qBAAqB;EACrB,kBAAkB;AACpB;;AAEA;EACE,2BAA2B;AAC7B;;AAEA;EACE,4BAA4B;AAC9B;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,mBAAmB;EACnB,uBAAuB;EACvB,OAAO;EACP,eAAe;EACf,mBAAmB;AACrB;;;CAGC;EACC,eAAe;EACf,eAAe;AACjB;;AAEA;EACE,kBAAkB;EAClB,YAAY;EACZ,WAAW;AACb;;;AAGA;EACE,uBAAuB;;AAEzB;;AAEA;EACE,iBAAiB;AACnB;;;AAGA;EACE,kBAAkB;EAClB,sBAAsB;EACtB,mBAAmB;EACnB,YAAY;EACZ,UAAU;EACV,iBAAiB;EACjB,mBAAmB;EACnB,gBAAgB;EAChB,kBAAkB;EAClB,oCAAoC;EACpC,4CAA4C;AAC9C;;AAEA;;;;EAIE,kBAAkB;AACpB;;;AAGA;;;;;EAKE,iBAAiB;EACjB,kBAAkB;EAClB,kBAAkB;EAClB,SAAS;EACT,SAAS;AACX;;;AAGA;EACE,aAAa;EACb,mBAAmB;EACnB,mBAAmB;EACnB,uBAAuB;EACvB,QAAQ;EACR,4CAA4C;EAC5C,kBAAkB;EAClB,qBAAqB;EACrB,mBAAmB;EACnB,YAAY;EACZ,UAAU;EACV,iBAAiB;;EAEjB,kBAAkB;EAClB,mCAAmC;AACrC;;;AAGA;EACE,qBAAqB;AACvB;;;AAGA;EACE,qBAAqB;EACrB,kBAAkB;EAClB,sBAAsB;EACtB,uBAAuB;EACvB,kBAAkB;EAClB,eAAe;EACf;;AAEF;EACE,cAAc;EACd;AACF,oBAAoB,4BAA4B,CAAC;AACjD,oBAAoB,aAAa,CAAC;;AAElC;EACE,kBAAkB;AACpB;;AAEA;EACE,WAAW;EACX,YAAY;AACd;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,eAAe;EACf,SAAS;EACT,SAAS;EACT,oBAAoB;EACpB,uBAAuB;EACvB,uBAAuB;EACvB,cAAc;EACd,UAAU;EACV,WAAW,EAAE,eAAe;EAC5B,YAAY,EAAE,gBAAgB;EAC9B,cAAc,EAAE,4BAA4B;EAC5C,4BAA4B,EAAE,mBAAmB;EACjD,iCAAiC,EAAE,qBAAqB;EACxD,wCAAwC;;AAE1C;;AAEA;EACE,YAAY;EACZ,kBAAkB;EAClB,SAAS;EACT,UAAU;EACV,kCAAkC;AACpC;;AAEA;EACE,yBAAyB;EACzB,eAAe;EACf,aAAa;EACb,sBAAsB;EACtB,UAAU,EAAE,oDAAoD;EAChE,mBAAmB;AACrB;;AAEA;EACE,kBAAkB;EAClB,UAAU;EACV,WAAW;;AAEb;;AAEA;EACE,gBAAgB;AAClB;;AAEA,qBAAqB;AACrB;EACE,WAAW;EACX,YAAY;EACZ,eAAe;EACf,iBAAiB;AACnB;;AAEA;;EAEE,YAAY;EACZ,qBAAqB;EACrB,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,uBAAuB;EACvB,WAAW;EACX,eAAe;EACf,kBAAkB;IAChB,UAAU;IACV,UAAU;EACZ,mBAAmB;AACrB;;AAEA;EACE,iBAAiB;EACjB,4CAA4C;AAC9C;AACA;AACA,WAAW;AACX;;AAEA;EACE,qBAAqB;AACvB","sourcesContent":["*{\n  box-sizing: border-box;\n}\nh1 {\n  font-size: 32px;\n  margin: 1rem 2rem;\n}\n\nh2 {\n  font-size: 22px;\n  margin: 0 0.1rem 0.5rem 0rem;\n}\n\n#explanation {\n  display: none;\n}\n\nbody {\n  font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;\n  margin-left: 1em;\n  background: #F5F5F5;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n}\n\nmain{\n  display: flex;\n  flex-direction: row;\n  gap: 20px;\n}\n\n.left{\n  width: calc(50% - 250px);\n  padding: 0 1rem;\n}\n\n\n\n.chart-container{\n  width: 490px;\n  height: 500px;\n  border: 1px solid black;\n  padding: 5px 2px 1px 15px; \n  border-radius: 10px;\n  background-color: white;\n}\n\n\n.right{\n  width: calc(50% - 250px);\n  padding: 0rem 1rem;\n}\n\ninput[type=button] {\n  background: #99ddee;\n  -webkit-border-radius: 15;\n  -moz-border-radius: 15;\n  border-radius: 5px;\n  width: 100%;\n  color: black;\n  font-size: 16px;\n  padding: 5px 10px 5px 10px; \n  text-decoration: none;\n  margin: 0;\n}\n\nbutton {\n  background: #99ddee;\n  -webkit-border-radius: 15;\n  -moz-border-radius: 15;\n  border-radius: 5px;\n  width: 100%;\n  color: black;\n  font-size: 16px;\n  padding: 5px 10px 5px 10px; \n  text-decoration: none;\n  margin: 0 0 1rem 0;\n}\n\n.plotdiv {\n  margin: 0rem 0rem 2rem 0rem;\n}\n\ninput[type=range] {\n  margin: .25rem 0 1.5rem 2rem;\n}\n\ninput[type=radio] {\n  margin: 0 0 0 2rem;\n}\n\nspan {\n  margin-left: 0px;\n}\n\n#eq {\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  justify-content: center;\n  gap:2px;\n  font-size: 2rem;\n  margin-bottom: 1rem;\n}\n\n\n #dep_var, #indep_var{\n  display: inline;\n  font-size: 2rem;\n}\n\n#exp{\n  position: relative;\n  top: -1.5rem;\n  width: 3rem;\n}\n\n\nul {\n  font-family: sans-serif;\n\n}\n\n.eq-label {\n  margin-left: 2rem;\n}\n\n\n.trendline-container-math {\n  font-size: 1.75rem;\n  border: 1px solid grey;\n  border-radius: 10px;\n  height: 3rem;\n  width: 90%;\n  margin-left: 2rem;\n  margin-bottom: 1rem;\n  padding-top: 6px;\n  text-align: center;\n  background-color: rgb(230, 230, 230);\n  font-family: 'Times New Roman', Times, serif;  \n}\n\n#trendline-equation-x-math, \n#trendline-equation-x-physics,\n#trendline-equation-y-math,\n#trendline-equation-y-physics{\n  font-style: italic;\n}\n\n\n#trendline-equation-x-math sup, \n#trendline-equation-x-physics sup,\n#trendline-equation-y-math sup,\n#trendline-equation-y-physics sup{\n  \n  font-size: 1.2rem;\n  font-style: normal;\n  position: relative;\n  top: -3px;\n  left: 4px;\n}\n\n\n.trendline-container-physics {\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  justify-content: center;\n  gap: 2px;\n  font-family: 'Times New Roman', Times, serif;\n  font-size: 1.75rem;\n  border: 1px solid red;\n  border-radius: 10px;\n  height: 3rem;\n  width: 90%;\n  margin-left: 2rem;\n  \n  text-align: center;\n  background-color: rgb(252, 252, 37);\n}\n\n\n.trendline {\n  display: inline-block;\n}\n\n\n.fraction {\n  display: inline-block;\n  position: relative;\n  vertical-align: middle; \n  letter-spacing: 0.001em;\n  text-align: center;\n  font-size: 14px;\n  }\n\n.fraction > span { \n  display: block; \n  }\n.fraction span.fdn {border-top: thin solid black;}\n.fraction span.bar {display: none;}\n\n.fraction sup {\n  position: relative;\n}\n\n#coefficient {\n  width: 4rem;\n  height: 2rem;\n}\n\n#modal {\n  display: none;\n}\n \n#modal.visible {\n  position: fixed;\n  top: 0rem;\n  left: 0vh;\n  padding: 0.5rem 1rem;\n  background-color: white;\n  border: 1px black solid;\n  display: block;\n  z-index: 1;\n  width: 100%; /* Full width */\n  height: 100%; /* Full height */\n  overflow: auto; /* Enable scroll if needed */\n  background-color: rgb(0,0,0); /* Fallback color */\n  background-color: rgba(0,0,0,0.4); /* Black w/ opacity */\n  font-family:Arial, Helvetica, sans-serif;\n\n}\n\n#modal-button {\n  width: 16rem;\n  position: absolute;\n  top: 1rem;\n  right:2rem;\n  background-color: rgb(200,200,200);\n}\n\n.modal-content {\n  background-color: #fefefe;\n  margin: 5% auto; \n  padding: 30px;\n  border: 1px solid #888;\n  width: 80%; /* Could be more or less, depending on screen size */\n  border-radius: 10px;\n}\n\n.modal-content span{\n  position: relative;\n  top: -15px;\n  right: -7px;\n\n}\n\n.modal-content h2 {\n  margin-top: 1rem;\n}\n\n/* The Close Button */\n.close {\n  color: #aaa;\n  float: right;\n  font-size: 28px;\n  font-weight: bold;\n}\n\n.close:hover,\n.close:focus {\n  color: black;\n  text-decoration: none;\n  cursor: pointer;\n}\n\n.plotted-trendline-container {\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n  color: blue;\n  font-size: 1rem;\n  position: relative;\n    left: 8rem;\n    top: -9rem;\n  align-items: center;\n}\n\n#plotted-trendline-x, #plotted-trendline-y, #plotted-trendline-slope{\n  font-size: 1.5rem;\n  font-family: 'Times New Roman', Times, serif; \n}\n#plotted-trendline-slope-3{\nmargin: 2px;\n}\n\n#error{\n  color: rgb(250, 0, 0);\n}"],"sourceRoot":""}]);
// Exports
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "makeCenter": () => (/* binding */ makeCenter),
/* harmony export */   "makeHeader": () => (/* binding */ makeHeader),
/* harmony export */   "makeLeftside": () => (/* binding */ makeLeftside),
/* harmony export */   "makeRightside": () => (/* binding */ makeRightside)
/* harmony export */ });
/* harmony import */ var _modalContent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modalContent */ "./src/modalContent.js");
...
const makeModal = () => {
  ...
  modalContentDiv.innerHTML = _modalContent__WEBPACK_IMPORTED_MODULE_0__["default"];
  const modal = document.getElementById('modal');
  modal.append(_modalContent__WEBPACK_IMPORTED_MODULE_0__["default"]);
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "plotFunction": () => (/* binding */ plotFunction),
/* harmony export */   "radioButtonCallback": () => (/* binding */ radioButtonCallback),
...
const sliderFunction = (experiment) => {
  const myChart = chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"].getChart(document.getElementById('myChart'));
  ...
  document.getElementById('trendline-equation-x-physics').innerHTML = `${(0,_helperFunctions__WEBPACK_IMPORTED_MODULE_2__.produceXLabel)(experiment.indepVarSymbol, choiceVal, true)}`;
  document.getElementById('fup1').textContent = `${(0,_helperFunctions__WEBPACK_IMPORTED_MODULE_2__.produceXUnits)(experiment.depVarUnits, 1, true)}`;
  document.getElementById('fdn1').textContent = `${(0,_helperFunctions__WEBPACK_IMPORTED_MODULE_2__.produceXUnits)(experiment.indepVarUnits, choiceVal, true)}`;
  document.getElementById('closing_paren').textContent = ')';
  document.getElementById('fup2').textContent = `${(0,_helperFunctions__WEBPACK_IMPORTED_MODULE_2__.produceXUnits)(experiment.depVarUnits, 1, true)}`;
  document.getElementById('fdn2').textContent = `${(0,_helperFunctions__WEBPACK_IMPORTED_MODULE_2__.produceXUnits)(experiment.indepVarUnits, choiceVal, true)}`;
};
...
const radioButtonCallback = (e, dataObject, experiment, prevExponent) => {
  ...
  myChart.options.scales.x.title.text = `${(0,_helperFunctions__WEBPACK_IMPORTED_MODULE_2__.produceXLabel)(xLabel, choiceVal)} `
  + `${(0,_helperFunctions__WEBPACK_IMPORTED_MODULE_2__.produceXLabel)(xSymbol, choiceVal)} (${(0,_helperFunctions__WEBPACK_IMPORTED_MODULE_2__.produceXUnits)(xUnits, choiceVal)})`;
  myChart.options.plugins.title.text = `${experiment.title} ${(0,_helperFunctions__WEBPACK_IMPORTED_MODULE_2__.produceXLabel)(yLabel, 1)} vs. ${(0,_helperFunctions__WEBPACK_IMPORTED_MODULE_2__.produceXLabel)(xLabel, choiceVal)}`;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "addNoise": () => (/* binding */ addNoise),
/* harmony export */   "produceXLabel": () => (/* binding */ produceXLabel),
/* harmony export */   "produceXUnits": () => (/* binding */ produceXUnits)
/* harmony export */ });
...
const makeChart = (experiment, dataObject, option) => {
  ...
  const myChartJS = new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"](ctx, {
    type: 'line',
    data: {
      datasets: [
        {
...
const makeData = (N, noise, coefficient, exponent, xMax, xPrecision, yPrecision) => {
  ...
  const baseWithNoiseSet = (0,_helperFunctions__WEBPACK_IMPORTED_MODULE_0__.addNoise)(baseSet, noise, exponent);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (makeData);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (pickExperiment);
...
/* harmony import */ var _makeChart__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./makeChart */ "./src/makeChart.js");
/* harmony import */ var _buildHTML__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./buildHTML */ "./src/buildHTML.js");
/* harmony import */ var _pickExperiment__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./pickExperiment */ "./src/pickExperiment.js");
/* harmony import */ var _makeData__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./makeData */ "./src/makeData.js");
/* harmony import */ var _callbackFunctions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./callbackFunctions */ "./src/callbackFunctions.js");
/* harmony import */ var _helperFunctions__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./helperFunctions */ "./src/helperFunctions.js");
...
const currentExperiment = (0,_pickExperiment__WEBPACK_IMPORTED_MODULE_3__["default"])(); // Object with exponent, labels, etc
...
const currentDataObject = (0,_makeData__WEBPACK_IMPORTED_MODULE_4__["default"])(
  N,
  noise,
  coefficient,
...
const myChart = (0,_makeChart__WEBPACK_IMPORTED_MODULE_1__["default"])(currentExperiment, currentDataObject, 1);
(0,_buildHTML__WEBPACK_IMPORTED_MODULE_2__.makeHeader)();
(0,_buildHTML__WEBPACK_IMPORTED_MODULE_2__.makeLeftside)(myChart);

const axisChoices = document.querySelectorAll('input[type=radio]');
axisChoices.forEach((choice) => {
  choice.addEventListener('change', (e) => {
    (0,_callbackFunctions__WEBPACK_IMPORTED_MODULE_5__.radioButtonCallback)(e, currentDataObject, currentExperiment, prevExponent);
...
slopeSlider.addEventListener('input', () => { (0,_callbackFunctions__WEBPACK_IMPORTED_MODULE_5__.sliderFunction)(currentExperiment); });

(0,_buildHTML__WEBPACK_IMPORTED_MODULE_2__.makeRightside)();
(0,_buildHTML__WEBPACK_IMPORTED_MODULE_2__.makeCenter)();

const plotFxnButton = document.getElementById('submit');
plotFxnButton.addEventListener('click', () => { (0,_callbackFunctions__WEBPACK_IMPORTED_MODULE_5__.plotFunction)(currentExperiment); });

document.querySelector('label[for="raw_data_option"]').innerHTML = ` ${(0,_helperFunctions__WEBPACK_IMPORTED_MODULE_6__.produceXLabel)(currentExperiment.indepVar, 1)} <br>`;
document.querySelector('label[for="sqd_data_option"]').innerHTML = ` ${(0,_helperFunctions__WEBPACK_IMPORTED_MODULE_6__.produceXLabel)(currentExperiment.indepVar, 2)} <br>`;
document.querySelector('label[for="inv_data_option"]').innerHTML = ` ${(0,_helperFunctions__WEBPACK_IMPORTED_MODULE_6__.produceXLabel)(currentExperiment.indepVar, -1)} <br>`;
document.querySelector('label[for="invsqd_data_option"]').innerHTML = ` ${(0,_helperFunctions__WEBPACK_IMPORTED_MODULE_6__.produceXLabel)(currentExperiment.indepVar, -2)} <br>`;
...
document.querySelector('#dep_var').textContent = `${currentExperiment.depVarSymbol} = (`;
document.querySelector('#indep_var').textContent = `) ${currentExperiment.indepVarSymbol}`;
document.querySelector('#fup2').textContent = (0,_helperFunctions__WEBPACK_IMPORTED_MODULE_6__.produceXUnits)(currentExperiment.depVarUnits, 1);
document.querySelector('#fdn2').textContent = (0,_helperFunctions__WEBPACK_IMPORTED_MODULE_6__.produceXUnits)(currentExperiment.indepVarUnits, 1);
